...
Успешным тест предлагается признать так как был получен прирост количества заказов в группе B, что при сопоставимом уровне среднего чека позволит увеличить выручку интернет магазина (заказовЧек).
